    ...
    <div className="bg-(--bg-color) font-sans overflow-x-hidden">
      ...
      >
        ...
        >
          ...
          <motion.em variants={wordVariants} className="text-(--accent-color) italic inline-block font-serif">
            prática
          </motion.em>
          {title2.map((word, idx) => (
            <motion.span key={idx} variants={wordVariants} className="inline-block">
        ...
        <motion.p 
          variants={itemVariants}
          className="relative text-white/40 text-base md:text-xl font-light max-w-lg leading-relaxed mb-10"
        >
